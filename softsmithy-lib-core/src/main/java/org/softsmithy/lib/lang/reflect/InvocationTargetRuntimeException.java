...
public class InvocationTargetRuntimeException extends RuntimeException {
    ...
    private static final long serialVersionUID = 5699874422023008268L;
    ...
    /**
     * Constructs an <code>InvocationTargetException</code> with <code>null</code> as the target exception.
     */
    ...
    /**
     * Returns the the cause of this exception (the thrown target exception, which may be {@code null}).
     *
