 ...
 * the origin to the new location, re-draws it, and so on. The standard
 ...
 * components would be affected. So this class overrides the
 * <code>validate</code>,
 * <code>revalidate</code>,
 * <code>repaint</code>, and
 * <code>firePropertyChange</code> methods to be no-ops. If you write your own renderer, please keep this performance
...
public abstract class PanelTableCellRenderer extends JPanel implements Serializable, TableCellRenderer {
    ...
    /**
     * Overrides
     * <code>JComponent.setForeground</code> to assign the unselected-foreground color to the specified color.
     *
    ...
    /**
     * Overrides
     * <code>JComponent.setBackground</code> to assign the unselected-background color to the specified color.
     *
     ...
     * <code>UIManager</code> that the look and feel has changed. Replaces the current UI object with the latest version
     * from the
     * <code>UIManager</code>.
     *
    ...
    /**
     * A subclass of
     * <code>DefaultTableCellRenderer</code> that implements
     * <code>UIResource</code>.
     * <code>DefaultTableCellRenderer</code> doesn't implement
     * <code>UIResource</code> directly so that applications can safely override the
     * <code>cellRenderer</code> property with
     * <code>DefaultTableCellRenderer</code> subclasses. <p> <strong>Warning:</strong> Serialized objects of this class
     * will not be compatible with future Swing releases. The current serialization support is appropriate for short
     * term storage or RMI between applications running the same version of Swing. As of 1.4, support for long term
